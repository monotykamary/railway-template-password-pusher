...
Deploy Password Pusher 2.13.0 on Railway with encrypted secret sharing, the built-in background worker, and persistent SQLite storage.

The Deploy on Railway button is added only after the published route has been verified.

## What this deploys

- Password Pusher `2.13.0`, pinned to the upstream Linux/AMD64 image digest
...
- The upstream `2.13.0` image publishes Linux/AMD64 only.
...
- Release: https://github.com/pglombardo/PasswordPusher/releases/tag/v2.13.0
