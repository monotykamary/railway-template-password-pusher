...
- Password Pusher `2.9.7`, pinned to the upstream Linux/AMD64 image digest
...
- The upstream `2.9.7` image publishes Linux/AMD64 only.
...
- Release: https://github.com/pglombardo/PasswordPusher/releases/tag/v2.9.7
